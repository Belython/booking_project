...
<head>
	...
	<link rel="stylesheet" href="calendar/tcal.css" type="text/css" />
				...
				<!--column-->
					...
					<div class="column twins">
						...
						<div class="f-item datepicker">
							...
							<div class="">
								<input class="tcal" type="text" placeholder="" id="checkInDate" name="checkInDate" value=""/>
							</div>
						</div>
						<div class="f-item datepicker">
							<label for="checkOutDate">Check-out date</label>
							<div class="">
								<input class="tcal" type="text" placeholder="" id="checkOutDate" name="checkOutDate" value=""/>
							</div>
						</div>
					</div>
					<!--//column-->
