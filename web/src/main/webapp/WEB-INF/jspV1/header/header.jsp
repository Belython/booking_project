...
<header>
    <div class="wrap clearfix">
        ...
        <!--login-->
        <%@include file="/WEB-INF/jspV1/header/login.jsp"%>
        <!--//login-->

        <!--registration-->
        <%@include file="/WEB-INF/jspV1/header/a_regisration.jsp"%>
        <!--//registration-->

        <!--remind password-->
        <%@include file="/WEB-INF/jspV1/header/forgot_password.jsp"%>
        <!--//remind password-->

        <!--Mesagebox-->
        <%@include file="/WEB-INF/jspV1/header/messagebox.jsp"%>
        <!--//Messagebox-->
