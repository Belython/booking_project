...
public class TestEntityBuilder {
    ...
    private static Location getUpdatedLocation() {
    ...
    private static Hotel getNewHotel() {
    ...
    private static List<Hotel> getUpdatedHotelList() {
    ...
    private static Hotel getUpdatedHotel() {
